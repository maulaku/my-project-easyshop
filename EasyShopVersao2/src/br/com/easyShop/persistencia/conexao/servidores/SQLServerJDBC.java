 ...
 */
public class SQLServerJDBC extends BaseJDBC
{
	/*-*-*-* Construtores *-*-*-*/
	/**
	 * Construtor vazio
	 ...
	 */
	public SQLServerJDBC(String endereco, String base, int porta, String login, String senha, PoolJDBC poolJDBC)
	{
		super("net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds:sqlserver://", endereco, base, porta, login, senha, poolJDBC);
	}
	...
	public Object SQLToObject(ResultSet resultSet, ResultSetMetaData resultSetMetaData, int index) throws Exception
	{
		...
		switch(resultSetMetaData.getColumnType(index))
		{
	        ...
	        case Types.NUMERIC:		{ return resultSet.getDouble(index); }
