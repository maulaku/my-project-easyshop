...
public class MainGerenciador
{
	public static void main(String[] args)
	{
		try
		{
			...
			Gerenciador.arquivoERM = "C:/EasyShop/siteCompras/EasyShop/src/br/com/easyShop/persistencia/modelagem.erm";
			Gerenciador.pathJavaOMs = "C:/EasyShop/siteCompras/EasyShop/src/br/com/easyShop/model";

			//Configuracoes para Gerar OMs Flex
			Gerenciador.pathFlexOMs = "C:/EasyShop/siteCompras/EasyShop/flex_src/br/com/easyShop/model";

			//Arquivo .acrtionScriptProperties
			Gerenciador.pathActionScriptProperties = "C:/EasyShop/siteCompras/EasyShop/.actionScriptProperties";
			Gerenciador.pathModulos.add(new PathASBase("C:/EasyShop/siteCompras/EasyShop", null));
			...
			Gerenciador.pathOMs.add("C:/EasyShop/siteCompras/EasyShop/src/br/com/easyShop/model");
